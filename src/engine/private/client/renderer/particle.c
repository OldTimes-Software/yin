...
static void PS_CB_DestroyEmitterTemplate( void *userData )
{
	...
	YinCore_Material_Release( emitter->material );
...
void PS_Draw( const PSEmitter *emitter, const YRCamera *camera )
{
	...
	YinCore_Material_DrawMesh( emitter->material, emitter->mesh, NULL, 0 );
