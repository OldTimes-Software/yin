...
struct NLNode *Engine_GetConfig( void );
...
#	define PROFILE_START( GROUP ) Profiler_StartMeasure( GROUP )
#	define PROFILE_END( GROUP )   Profiler_EndMeasure( GROUP )
#else
...
#endif
void          Profiler_UpdateGraphs( void );
...
void Console_RegisterCommands( bool isDedicated );
void Console_RegisterVariables( bool isDedicated );
