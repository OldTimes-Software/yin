...
struct NLNode *Common_GetConfig( const char *name );// attempts to fetch the specified config, otherwise returns an empty config
bool           Common_WriteConfig( struct NLNode *root, const char *name );
